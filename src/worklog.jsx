...
const WorkLog = () => {
  ...
  const [newversionsCheck, setnewversionsCheck] = React.useState(false);
  ...
  React.useEffect(() => {
    ...
    checkNewVersions();
    // }, 60000);
  }, [window.localStorage.getItem("newVersion")]);
  ...
  const UserLogin = () => {
    ...
    const config = {
      method: "POST",
      url: `https://authapi.virtualstaff.ph/api/v1/auth/trackerlogin`, //https://authapi.virtualstaff.ph/api/v1/auth/trackerlogin
      data: userDatas,
      headers: {
        "Content-Type": "application/json",
        Accept: "application/json",
